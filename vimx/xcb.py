...
def startup():
    ...
    conn.core.ChangeProperty(PropMode.Replace, window, 1, 0, 8, len(name), name)
...
def paint():
    ...
    for x in xrange(0, 7):
        for y in xrange(0, 5):
            ...
            conn.render.FillRectangles(render.PictOp.Src, pid, color, 1, rectangle)
